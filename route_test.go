...
func TestHandlerName(t *testing.T) {
	...
	var testCases = []struct {
	...
	}{
		{
			...
			expect: "github.com/datumforge/echox.TestHandlerName.func2",
		},
		{
			name:            "ok, func as named function variable",
			whenHandlerFunc: myNameFuncVar,
			expect:          "github.com/datumforge/echox.TestHandlerName.func1",
		},
		{
			name:            "ok, func as struct method",
			whenHandlerFunc: tmp.getUsers,
			expect:          "github.com/datumforge/echox.(*NameStruct).getUsers-fm",
		},
	}
...
func TestHandlerName_differentFuncSameName(t *testing.T) {
	...
	assert.Equal(t, "github.com/datumforge/echox.TestHandlerName_differentFuncSameName.TestHandlerName_differentFuncSameName.func1.func2", HandlerName(h1))

	h2 := handlerCreator("name2")
	assert.Equal(t, "github.com/datumforge/echox.TestHandlerName_differentFuncSameName.TestHandlerName_differentFuncSameName.func1.func3", HandlerName(h2))
}
